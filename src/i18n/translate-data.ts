...
const FRAG: Record<string, Record<string, string>> = {
  ...
  he: {
    ...
    "Gespräche beginnen (informell)": "לפתוח בשיחה (בלתי־פורמלי)",
    "Ton / Video": "שמע / וידאו",
    ...
    "Programm für September ist online": "תוכנית ספטמבר זמינה כעת",
    "vor 2 Std.": "לפני שעתיים",
    "heute, 08:00": "היום, 08:00",
    "Montag": "יום שני",
    "gerade eben": "הרגע",
    "Über Jehovas Eigenschaften nachzudenken, stärkt unseren Glauben": "התבוננות בתכונות יהוה מחזקת את אמונתנו",
    "Geh während der besonderen Aktion zielorientiert vor": "פעל למען מטרה במהלך המבצע המיוחד",
  ...
  fa: {
    ...
    "Gespräche beginnen (informell)": "شروع گفتگو (غیررسمی)",
    "Ton / Video": "صدا / تصویر",
    ...
    "Programm für September ist online": "برنامهٔ سپتامبر اکنون در دسترس است",
    "vor 2 Std.": "۲ ساعت پیش",
    "heute, 08:00": "امروز، ۰۸:۰۰",
    "Montag": "دوشنبه",
    "gerade eben": "همین الان",
    "Über Jehovas Eigenschaften nachzudenken, stärkt unseren Glauben": "تفکر دربارهٔ صفات یَهُوَه ایمان ما را تقویت می‌کند",
    "Geh während der besonderen Aktion zielorientiert vor": "در جریان اقدام ویژه هدفمند عمل کنید",
  ...
  ur: {
    ...
    "Gespräche beginnen (informell)": "گفتگو کا آغاز (غیر رسمی)",
    ...
    "Programm für September ist online": "ستمبر کا پروگرام اب دستیاب ہے",
    "vor 2 Std.": "۲ گھنٹے پہلے",
    "heute, 08:00": "آج، ۰۸:۰۰",
    "Montag": "پیر",
    "gerade eben": "ابھی ابھی",
    "Über Jehovas Eigenschaften nachzudenken, stärkt unseren Glauben": "یہوواہ کی صفات پر غور کرنا ہمارے ایمان کو مضبوط کرتا ہے",
    "Geh während der besonderen Aktion zielorientiert vor": "خصوصی مہم کے دوران ہدف کے مطابق کام کریں",
