...
export const DE = {
    ...
    fsGrundplan: 'GRUNDPLAN TREFFPUNKTE',
    ...
    fsVersSection: 'VERSAMMLUNGSTREFFPUNKTE',
    ...
    dashZuBest: 'Zu bestätigen', dashPlanung: 'Planung',
    ...
    inviteMailSubject: 'Einladung: Congregation Planner',
    ...
    inviteShareText: 'Einladung zum Congregation Planner: {url} — Einladungscode: {code}',
    ...
    wochenGeladen: '{n} Wochen geladen',
    ...
    planSendenOffen: '{n} Zuteilungen dieser Woche sind noch niemandem mitgeteilt.',
