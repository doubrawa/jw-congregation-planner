...
const TEXTE: Record<string, PushTexte> = {
  ...
  fr: { erinnerung: 'Rappel\u00a0: confirme ton attribution', unerreichbar: 'Attributions non confirmées (injoignables)' },
  it: { erinnerung: 'Promemoria: conferma il tuo incarico', unerreichbar: 'Incarichi non confermati (non raggiungibili)' },
  pt: { erinnerung: 'Lembrete: confirme sua designação', unerreichbar: 'Designações não confirmadas (sem contato)' },
  ...
  id: { erinnerung: 'Pengingat: konfirmasi tugas Anda', unerreichbar: 'Tugas belum dikonfirmasi (tidak terjangkau)' },
  tl: { erinnerung: 'Paalala: kumpirmahin ang iyong atas', unerreichbar: 'Hindi pa nakumpirmang atas (hindi maabot)' },
  vi: { erinnerung: 'Nhắc nhở: hãy xác nhận phân công', unerreichbar: 'Phân công chưa xác nhận (không liên lạc được)' },
